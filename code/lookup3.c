      ...
      for (j = 0; j < 8; ++j) /*------------------------ for each input bit, */
      {
             ...
             ++m) /*------------ for serveral possible initvals, */
        {
          ...
          if (k == MAXPAIR) {
            ...
            printf("%.8x %.8x %.8x %.8x %.8x %.8x  ", e[0], f[0], g[0], h[0],
                   x[0], y[0]);
...
void driver3() {
  ...
  uint32_t len;
  uint8_t q[] = "This is the time for all good men to come to the aid of their "
                "country...";
  uint32_t h;
  ...
  uint8_t qqq[] = "xxThis is the time for all good men to come to the aid of "
                  "their country...";
  uint32_t j;
  uint8_t qqqq[] = "xxxThis is the time for all good men to come to the aid of "
                   "their country...";
  uint32_t ref, x, y;
  uint8_t *p;
