...
kernel void
quiz_population(const uint16_t quiz_independentClause_list_size,
                constant const v16us *restrict quiz_independentClause_list,
                const uint16_t program_size, const uint8_t population_size,
                constant const v16us *restrict population,
                global uint8_t *champion, global uint16_t *champion_worth) {
